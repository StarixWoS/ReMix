...
public:
    ...
    void setupUi(QWidget *ReMixWidget)
    {
        ...
        sizePolicy5.setHeightForWidth(openBanDialog->sizePolicy().hasHeightForWidth());
        openBanDialog->setSizePolicy(sizePolicy5);
        ...
        sizePolicy5.setHeightForWidth(openRemoteAdmins->sizePolicy().hasHeightForWidth());
        openRemoteAdmins->setSizePolicy(sizePolicy5);
