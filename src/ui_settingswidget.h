...
public:
    ...
    void retranslateUi(QWidget *SettingsWidget)
    {
        ...
        ___qtablewidgetitem16->setText(QApplication::translate("SettingsWidget", "Require Password", 0));
        QTableWidgetItem *___qtablewidgetitem17 = settingsView->item(1, 0);
        ___qtablewidgetitem17->setText(QApplication::translate("SettingsWidget", "Require Remote-Admin Auth", 0));
        QTableWidgetItem *___qtablewidgetitem18 = settingsView->item(2, 0);
        ___qtablewidgetitem18->setText(QApplication::translate("SettingsWidget", "Allow Duplicate IP's", 0));
        ...
        ___qtablewidgetitem22->setText(QApplication::translate("SettingsWidget", "Disconnect Idle Users", 0));
        QTableWidgetItem *___qtablewidgetitem23 = settingsView->item(7, 0);
        ___qtablewidgetitem23->setText(QApplication::translate("SettingsWidget", "Allow Server Variables", 0));
        QTableWidgetItem *___qtablewidgetitem24 = settingsView->item(8, 0);
        ___qtablewidgetitem24->setText(QApplication::translate("SettingsWidget", "Log Comments to File", 0));
        QTableWidgetItem *___qtablewidgetitem25 = settingsView->item(9, 0);
        ___qtablewidgetitem25->setText(QApplication::translate("SettingsWidget", "Echo Comment to Admins", 0));
        QTableWidgetItem *___qtablewidgetitem26 = settingsView->item(10, 0);
        ___qtablewidgetitem26->setText(QApplication::translate("SettingsWidget", "Echo Comment to Users (Sender)", 0));
        QTableWidgetItem *___qtablewidgetitem27 = settingsView->item(11, 0);
        ___qtablewidgetitem27->setText(QApplication::translate("SettingsWidget", "Inform Admins of Login Events", 0));
        QTableWidgetItem *___qtablewidgetitem28 = settingsView->item(12, 0);
        ___qtablewidgetitem28->setText(QApplication::translate("SettingsWidget", "Minimize to System Tray", 0));
        QTableWidgetItem *___qtablewidgetitem29 = settingsView->item(13, 0);
        ___qtablewidgetitem29->setText(QApplication::translate("SettingsWidget", "Save Window Positions", 0));
        QTableWidgetItem *___qtablewidgetitem30 = settingsView->item(14, 0);
        ___qtablewidgetitem30->setText(QApplication::translate("SettingsWidget", "World Directory", 0));
